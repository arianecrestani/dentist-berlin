...
export const Dentist = ({ item, index, feedback, favorite }) => {
  ...
  >
    <Flex justifyContent="center" alignItems="center" >
      <Avatar name={item.tags.name} src="https://bit.ly/broken-link" size="xl" />
      <Box ml={8}>
        <Heading as="h2" size="lg">
          {item.tags.name}
        </Heading>
        <Text fontSize="md" color="gray.500" mt={2}>
          {item.tags["addr:street"]} {item.tags["addr:housenumber"]} {item.tags["addr:city"]} {item.tags["addr:postcode"]}
        </Text>
        <Text fontSize="md" color="gray.500" mt={2}>
